...
def display_decrypt():
    plaintext_entry1.insert("2.0", decryptionFunc())
##########################################################################
# start of GUI
root = Tk()  # root window
...
titleFrame.pack(side=TOP, pady=30)

topFrame = Frame(root)
topFrame.pack(pady=10)

bottomFrame = Frame(root)
bottomFrame.pack(side=LEFT, padx=15)
...
key_label.pack(side=LEFT, fill=Y, pady=10)

key_input = Entry(topFrame)
key_input.pack(side=LEFT, fill=Y, pady=10)

key_button = Button(topFrame, text="select")
key_button.pack(side=LEFT, fill=Y)

plaintext_label = Label(bottomFrame, text="Plaintext > Encypted")
plaintext_label.pack(pady=10)

plaintext_entry = Text(bottomFrame)
plaintext_entry.pack()

plaintext_button = Button(bottomFrame, text="Encrypt", command=display_encrypt)
plaintext_button.pack(pady=10)

plaintext_label1 = Label(bottomFrame1, text="Encypted > Plaintext")
plaintext_label1.pack(pady=10)

plaintext_entry1 = Text(bottomFrame1)
plaintext_entry1.pack()

plaintext_button1 = Button(bottomFrame1, text="Decrypt", command=display_decrypt)
plaintext_button1.pack(pady=10)

third_frame = Frame(root, bg="grey")
